	...
	<div class="container-fluid">
		<div class="row">
			<ul id="main-nav" class="nav nav-tabs nav-stacked" style="">
				<li><a href="#personalInfo" class="nav-header collapsed"
					data-toggle="collapse"> 个人信息 <span
						class="pull-right glyphicon glyphicon-chevron-down"></span>
				</a>
					<ul id="personalInfo" class="nav nav-list collapse secondmenu"
						style="height: 0px;">
				...
				<li><a href="#myRepair" class="nav-header collapsed"
					data-toggle="collapse"> 我的报修 <span
						class="pull-right glyphicon glyphicon-chevron-down"></span>
				</a>
					<ul id="myRepair" class="nav nav-list collapse secondmenu"
						style="height: 0px;">
						<li><a href="<c:url value='/page/sendRepair.do'/>">我要报修</a></li>
						<li><a href="<c:url value='/student/repairHistory.do'/>">报修历史</a></li>
					</ul></li>
			</ul>
		</div>
	</div>
