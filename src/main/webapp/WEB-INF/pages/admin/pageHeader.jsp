...
<div class="main-header">
	<div class="container-fuild bg-info">
		...
		<div class="LoginRegist">
			...
			%>
			<span style="color: #3591E3;">欢迎你，<%=userName%></span> / <a
				href="<c:url value='/page/logout.do'/>">注销</a>
			<%
				} else if (obj2 != null) {
					String compName = ((Admin) obj2).getName();
			%>
			<span style="color: #3591E3;">欢迎你，<%=compName%></span> / <a
				href="<c:url value='/page/logout.do'/>">注销</a>
			<%
				}
			%>
			<br> <label id="timeShow"> </label>
		</div>
	</div>
</div>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="<c:url value='/news/adminNews.do'/>">news</a></li>
					<li><a href="<c:url value='/advise/adviseList.do'/>">advise</a></li>
					<li><a href="<c:url value='/about/adminAbout.do'/>">about us</a></li>
				</ul>
			</div>
		</div>
	</nav>
